package com.example.application.views.collaborative;
...
@Route(value = "collaborative/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@RouteAlias(value = "", layout = MainLayout.class)
@Uses(Icon.class)
public class CollaborativeView extends Div implements BeforeEnterObserver {

    public static final String TOPIC_ID = "personform_collaborative";
    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "collaborative/%d/edit";
    ...
    public CollaborativeView(@Autowired SamplePersonService samplePersonService) {
